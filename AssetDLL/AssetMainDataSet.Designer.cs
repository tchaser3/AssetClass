...
namespace AssetDLL {
    ...
    public partial class AssetMainDataSet : global::System.Data.DataSet {
        ...
        public partial class assetmainDataTable : global::System.Data.TypedTableBase<assetmainRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public assetmainRow AddassetmainRow(string AssetPartNumber, int AssetTypeID, string AssetDescription, decimal AssetCost, int WarehouseID, int EmployeeID, bool AssetActive, System.DateTime ActiveDate, string AssetNotes, System.DateTime RetirementDate, string RetirementNotes, System.DateTime DataEntryDate) {
...
namespace AssetDLL.AssetMainDataSetTableAdapters {
    ...
    public partial class assetmainTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[assetmain] ([AssetPartNumber], [AssetTypeID], [AssetDescription], [AssetCost], [WarehouseID], [EmployeeID], [AssetActive], [ActiveDate], [AssetNotes], [RetirementDate], [RetirementNotes], [DataEntryDate]) VALUES (@AssetPartNumber, @AssetTypeID, @AssetDescription, @AssetCost, @WarehouseID, @EmployeeID, @AssetActive, @ActiveDate, @AssetNotes, @RetirementDate, @RetirementNotes, @DataEntryDate);
SELECT AssetID, AssetPartNumber, AssetTypeID, AssetDescription, AssetCost, WarehouseID, EmployeeID, AssetActive, ActiveDate, AssetNotes, RetirementDate, RetirementNotes, DataEntryDate FROM assetmain WHERE (AssetID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[assetmain] SET [AssetPartNumber] = @AssetPartNumber, [AssetTypeID] = @AssetTypeID, [AssetDescription] = @AssetDescription, [AssetCost] = @AssetCost, [WarehouseID] = @WarehouseID, [EmployeeID] = @EmployeeID, [AssetActive] = @AssetActive, [ActiveDate] = @ActiveDate, [AssetNotes] = @AssetNotes, [RetirementDate] = @RetirementDate, [RetirementNotes] = @RetirementNotes, [DataEntryDate] = @DataEntryDate WHERE (([AssetID] = @Original_AssetID) AND ([AssetTypeID] = @Original_AssetTypeID) AND ([AssetCost] = @Original_AssetCost) AND ([WarehouseID] = @Original_WarehouseID) AND ([EmployeeID] = @Original_EmployeeID) AND ([AssetActive] = @Original_AssetActive) AND ([ActiveDate] = @Original_ActiveDate) AND ((@IsNull_RetirementDate = 1 AND [RetirementDate] IS NULL) OR ([RetirementDate] = @Original_RetirementDate)) AND ([DataEntryDate] = @Original_DataEntryDate));
SELECT AssetID, AssetPartNumber, AssetTypeID, AssetDescription, AssetCost, WarehouseID, EmployeeID, AssetActive, ActiveDate, AssetNotes, RetirementDate, RetirementNotes, DataEntryDate FROM assetmain WHERE (AssetID = @AssetID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT AssetID, AssetPartNumber, AssetTypeID, AssetDescription, AssetCost, Wareho" +
                ...
                "ntNotes, DataEntryDate FROM dbo.assetmain";
        ...
        public virtual int Insert(string AssetPartNumber, int AssetTypeID, string AssetDescription, decimal AssetCost, int WarehouseID, int EmployeeID, bool AssetActive, System.DateTime ActiveDate, string AssetNotes, global::System.Nullable<global::System.DateTime> RetirementDate, string RetirementNotes, System.DateTime DataEntryDate) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_AssetTypeID));
            this.Adapter.UpdateCommand.Parameters[14].Value = ((decimal)(Original_AssetCost));
            ...
            this.Adapter.UpdateCommand.Parameters[17].Value = ((bool)(Original_AssetActive));
            this.Adapter.UpdateCommand.Parameters[18].Value = ((System.DateTime)(Original_ActiveDate));
            if ((Original_RetirementDate.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[19].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[20].Value = ((System.DateTime)(Original_RetirementDate.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[19].Value = ((object)(1));
                this.Adapter.UpdateCommand.Parameters[20].Value = global::System.DBNull.Value;
            }
            this.Adapter.UpdateCommand.Parameters[21].Value = ((System.DateTime)(Original_DataEntryDate));
            this.Adapter.UpdateCommand.Parameters[22].Value = ((int)(AssetID));
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<global::System.DateTime> Original_RetirementDate, 
                    System.DateTime Original_DataEntryDate) {
            return this.Update(AssetPartNumber, AssetTypeID, AssetDescription, AssetCost, WarehouseID, EmployeeID, AssetActive, ActiveDate, AssetNotes, RetirementDate, RetirementNotes, DataEntryDate, Original_AssetID, Original_AssetTypeID, Original_AssetCost, Original_WarehouseID, Original_EmployeeID, Original_AssetActive, Original_ActiveDate, Original_RetirementDate, Original_DataEntryDate, Original_AssetID);
        }
    }
